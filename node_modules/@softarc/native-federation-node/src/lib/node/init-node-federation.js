...
function loadFsFederationInfo(relBundlePath, options) {
    return __awaiter(this, void 0, void 0, function* () {
        const manifestPath = path.join(relBundlePath, 'remoteEntry.json' + (options === null || options === void 0 ? void 0 : options.cacheTag) ? `?t=${options.cacheTag}` : '');
